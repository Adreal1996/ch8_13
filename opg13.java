...
The method should modify the two BankAccount objects such that “this” current object has its balance decreased by
the given amount plus the $5 fee, and the other account's balance is increased by the given amount.
If this account object does not have enough money to make the full transfer,
transfer whatever money is left after the $5 fee is deducted.
...
public class opg13
{
    ...
    public void transfer (opg13 account, double amount)
    {
        int fee = 5;

        if(balance < amount + fee)
        {
            System.out.println("Du har ikke nok $$$ til at overføre så meget.");
            System.out.println("Der vil blive overført så meget som muligt.");
